...
const NoteEditor = lazy(() => import('../features/notes/screens/NoteEditor'));
const Note = lazy(() => import('../features/notes/screens/Note'));
const Settings = lazy(() => import('../features/settings/screens/Settings'));
const BiometricLogin = lazy(
  () => import('../features/auth/screens/BiometricLogin'),
);
